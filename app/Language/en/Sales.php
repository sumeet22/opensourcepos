...
return [
    ...
    "visa"                             => "",
    "wallet"                           => "Wallet",
    "whatsapp_no_phone"                => "No phone number on file. Please enter a phone number to send via WhatsApp.",
    "whatsapp_phone_label"             => "Phone number (with country code, e.g. +91 98765 43210)",
    "whatsapp_phone_required"          => "Please enter a phone number.",
    "whatsapp_receipt_footer"          => "Thank you for your purchase!",
    "whatsapp_sent"                    => "WhatsApp message opened for",
    "wholesale"                        => "",
